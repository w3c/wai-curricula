...
* write markup for content so that it is presented in a meaningful sequence
* style and write markup for content so that it has a distinguishable focus indicator
