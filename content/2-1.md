...
* Demonstrate use of HTML links that allow to bypass blocks of content that repeats on multiple pages. Explain that keyboard-only users, such as users with motor disabilities, rely on them to skip large blocks of repetitive content, such as headers and navigation bars. For reference on how to code such links, see technique [G1: Adding a link at the top of each page that goes directly to the main content area](https://www.w3.org/WAI/WCAG21/Techniques/general/G1.html).
