...
* Demonstrate use of the `title` element within the `head` tag to convey page topic or purpose. Show examples of where and how browser and assistive technologies show the contents of the `title` element: screen reader keystrokes, browser tabs, browser window titles, and search results. Relate this requirement to WCAG success criteria [2.4.2 Page Titled](https://www.w3.org/WAI/WCAG21/quickref/#page-titled). For reference on how to provide descriptive titles, see technique [G88: Providing descriptive titles for Web pages](https://www.w3.org/WAI/WCAG21/Techniques/general/G88.html) and [H25: Providing a title using the title element](https://www.w3.org/WAI/WCAG21/Techniques/html/H25). For best practices on how to write page titles, see the Easy Checks resource, section [Page title](https://www.w3.org/WAI/test-evaluate/preliminary/#title).
