...
* Demonstrate use of HTML links that allow to bypass blocks of content that repeats on multiple pages. Explain that keyboard-only users rely on them to skip large blocks of repetitive content, such as headers and navigation bars. Examples of how to code such links are provided in technique [G1: Adding a link at the top of each page that goes directly to the main content area](https://www.w3.org/WAI/WCAG21/Techniques/general/G1.html).
