...
* Recognize how assistive technology users navigate different sections of a website.
...
* Identify the following user strategies to browse web content:
  * Use of key combination such as the tab, arrow, enter, or escape keys.
  * Keystrokes for screen reader users to jump to specific sections.
  * Some commands of speech recognition software.
  * Some switch controls that emulate keyboard presses.
  * Some browser extensions that allow to get to the main region of a website.
