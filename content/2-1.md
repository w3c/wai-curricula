...
* In-depth knowledge of:
  ...
  * [Principles, Standards, and Checks](https://www.w3.org/WAI/curricula/introduction-to-web-accessibility/principles-standards-and-checks/).
  * [HTML5 sections](https://html.spec.whatwg.org/multipage/sections.html#sections).
  * [WAI Web Accessibility Tutorials (Page Structure)](https://www.w3.org/WAI/tutorials/page-structure/).
  * WAI-ARIA landmarks.
...
Discuss how people use page regions for navigation. For example, header, footer, navigation, or main. Discuss common markup for page regions.

#### Learning Outcomes for Topic

Students should be able to:

* Describe how people interact with and move to different regions of a web page using:
  ...
  * Reader views that show the reading contents of the page.
...
* Invite students to try out the so-called reader mode built-in to some browsers. Explain that it changes the layout of the page, showing the main content of a web page when it is marked up appropriately. Discuss with students how this can improve readability for all users. For reference on how to use the reader mode, refer to the support pages of the browsers.
...
* Show examples of different page layouts, including header, navigation, main content, and footer. For guidance on how to use HTML5 sections, see the WAI website tutorials, [Regions](https://www.w3.org/WAI/tutorials/page-structure/regions/).
...
Apply `h1` through `h6` tags to identify and label page sections and passages of content. Explain that they are also used by some assistive technology users to orient and navigate.

#### Learning Outcomes for Topic

Students should be able to:

* Describe how people interact with headings using:
  * Browser extensions or screen reader keystrokes to go to next or previous heading.
...
Demonstrate use of the `title` attribute to identify pages in the context of a website. Demonstrate use of the `lang` attribute to identify the language of a web page or passage of text.
...
* Demonstrate use of the `title` element within the `head` tag to convey page topic or purpose. Show examples of where and how browser and assistive technologies show the contents of the `title` element: screen reader keystrokes, browser tabs, browser window titles, and search results. Relate this requirement to WCAG success criterion [2.4.2 Page Titled](https://www.w3.org/WAI/WCAG21/quickref/#page-titled). For reference on how to provide descriptive titles, see technique [G88: Providing descriptive titles for Web pages](https://www.w3.org/WAI/WCAG21/Techniques/general/G88.html) and [H25: Providing a title using the title element](https://www.w3.org/WAI/WCAG21/Techniques/html/H25). For best practices on how to write page titles, see the Easy Checks resource, section [Page title](https://www.w3.org/WAI/test-evaluate/preliminary/#title).
...
* Practice &mdash; Students are directed to a site and are asked to determine if page titles  are descriptive. Assess students' understanding of how to write titles for pages.
...
Discuss HTML elements to convey the structure of contents in a web page. For example, sections, paragraphs, lists, and tables.
