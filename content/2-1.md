...
* list requirements for content authors to write heading texts such as putting distinctive information up-front
* list requirements for designers to design visual styles for headings, such as using distinctive styles for each of the headings
...
* list complimentary requirements for authors to mark up content with proper semantic structures
...
* list complimentary requirements for designers to design distinctive focus indicators and to design an information architecture that allows to present information in multiple layouts

#### Teaching Ideas for Topic

Optional ideas to teach the learning outcomes:

* Demonstrate use of  the HTML element `title` within the `head` element to convey the topic or purpose of the page. Show examples of where and how browsers and assistive technologies show the contents of the `title` element: screen reader keystrokes, browser tabs, browser window titles, and search results. Relate this requirement to WCAG success criterion [2.4.2 Page Titled](https://www.w3.org/WAI/WCAG21/quickref/#page-titled). Examples on how to provide descriptive titles are provided in techniques [G88: Providing descriptive titles for Web pages](https://www.w3.org/WAI/WCAG21/Techniques/general/G88.html) and [H25: Providing a title using the title element](https://www.w3.org/WAI/WCAG21/Techniques/html/H25). Examples of how to write page titles are provided in the Easy Checks resource, section [Page title](https://www.w3.org/WAI/test-evaluate/preliminary/#title).
* Demonstrate use of the `lang` attribute to convey the main language of a web page. Explain that it is placed within the `html` tag, and that it takes a value from [BCP47: Tags for the identification of languages](http://www.rfc-editor.org/rfc/bcp/bcp47.txt). Examples on how to convey the main language of a web page are provided in technique [H57: Using the language attribute on the HTML element](https://www.w3.org/WAI/WCAG21/Techniques/html/H57.html).
...
* Demonstrate use of HTML links that allow to bypass blocks of content that repeats on multiple pages. Explain that keyboard-only users, such as users with motor disabilities, rely on them to skip large blocks of repetitive content, such as headers and navigation bars. Examples on how to code such links are provided in technique [G1: Adding a link at the top of each page that goes directly to the main content area](https://www.w3.org/WAI/WCAG21/Techniques/general/G1.html).
