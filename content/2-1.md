...
* list requirements for content authors to write heading texts such as putting relevant information up-front
...
* list requirements for authors to use appopriate structures such as paragraphs and list to convey the meanng of content
...
* list requirements for designers to design an information architecture that allows to present information in different layouts
