...
* explain how semantic markup helps communicate the meaning of content to people with disabilities
...
* explain how headings provide a summary of page content that can be used by assistive technologies for orientation
...
* recite related requirements for authors to use appropriate structures to convey content meaning, such as paragraphs and lists
...
* mark up page titles to allow people to identify the web page
...
* recite related requirements for designers to create designs that support different viewport sizes
* recite related requirements for authors to write meaningful page titles
