...
* list requirements for authors to use appropriate structures such as paragraphs and list to convey content meaning
...
* Define quotes as text attributed to another author. Explain that there can be inline or block quotes, and that they are marked up using the HTML elements `q` and `blockquote` respectively. Examples on how to code quotes, see the WAI tutorials on [Quotes](https://www.w3.org/WAI/tutorials/page-structure/content/#quotes).
...
* list requirements for designers to create designs for different viewport sizes
