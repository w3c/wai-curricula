...
* Use headings to convey the structure of text passages.
...
* Demonstrate use of the tab and shift + tab keys to move between different components of a web page. Underline that keeping focus order allows for consistency between the visual and programmatic order of items within a user interface.
