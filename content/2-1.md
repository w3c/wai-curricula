...
* Use HTML5 sectioning elements and WAI-ARIA landmarks to convey structure and semantics in web pages and meet success criterion 1.3.1 Infor and Relationships.
...
* Label the different sections of a web page so that they can be identified by assistive technology users to meet success criterion 2.4.6 Headings and Labels.
