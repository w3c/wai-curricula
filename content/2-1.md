...
Introduce the role of headings to identify and label sections of a web page.
...
* Understand some assistive technology user strategies to navigate through the different sections of the web page.
...
* Markup sections of a web page with ARIA landmarks to make regions available for old browsers and assistive technologies.

#### teaching Ideas

Optional ideas to teach de learning outcomes.

* Demonstrate use of some mechanisms of screen readers to get to different regions of a web page. Explain that some times specific keystrokes are used to get to each region in a sequential order, and some others more advanced functionality presents all the regions of a web page in a tree list. Mention that these structural components help users orient an navigate web pages.
* Demonstrate use of some browser extensions that allow users to get to the main region of a web page.
...
* Markup content headings with their corresponding `h1` through `h6` level according to the hierarchical structure of the page.
