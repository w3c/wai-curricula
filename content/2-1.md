...
* Define the purpose and scope of `header`, `nav`, `main`, `section`, `article`, `aside`, and `footer` elements.
...
* [Web Accessibility Perspectives (videos)](/perspective-videos/) &mdash; Is a series of 1-minute videos that show accessibility features and how they impact people with disabilities.
