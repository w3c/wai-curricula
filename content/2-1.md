...
* identify the need to use HTML native elements to the extent possible for broader compatibility with assistive technologies and adaptive strategies
...
* Basic knowledge of [HTML5 grouping content](https://html.spec.whatwg.org/multipage/grouping-content.html)
