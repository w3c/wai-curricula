...
* Determine if HTML5 sectioning elements and WAI-ARIA landmarks:
  * Are used according to the specifications.
  * Meet success criteria 1.3.1 (Info and Relationships), 2.4.1 (Bypass Blocks), and 2.4.6 (Headings and Labels) of Web Content Accessibility Guidelines (WCAG).
...
Introduce some aspects related to how users interact with websites and applications. For example, demonstrate how an interface can be navigated using the keyboard only or an assistive technology.

#### Learning Outcomes for Topic

Students should be able to:

* Identify use of key combination such as the tab, the arrow, the enter, or the escape keys to navigate web interfaces.
* Identify common usages of screen readers, screen magnifiers and speech recognition software, together with some adaptive strategies  to browse the Web.
...
* Explain that the type of element in use and its accessibility properties determine how an assistive technology communicates information to users. Indicate that users can quickly get to different sections by using specific key combinations of their assistive products or extensions for their browsers.
