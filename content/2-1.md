...
* Use the appropriate markup to identify different parts of a web page.
* Label the different sections of a web page so that they can be identified by assistive technology users.
* Determine if the following success criteria of Web Content Accessibility Guidelines (WCAG) are met:
...
* Practice &mdash; Students provide appropriate HTML markup for a given piece of content. Assess how students identify and use headings, lists, paragraphs, quotes, tables, etc., to convey the structure of the content.
