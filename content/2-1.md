...
* Demonstrate use of commands, keystrokes, or gestures of text-to-speech technologies to move to next or previous heading. Explore advanced functionality which presents all headings in a list where users can select the heading they are interested in. For reference on how people with disabilities interact and navigate web pages, see [Stories of Web Users](https://www.w3.org/WAI/people-use-web/user-stories/).
