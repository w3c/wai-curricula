...
* Applied expertise in:
  ...
  * @@@ add other SCs, eg page title, language of parts, etc.
  * [HTML5 sections](https://html.spec.whatwg.org/multipage/sections.html#sections).
...
* Describe how people with disabilities interact with and move to different regions of a web page by using:
