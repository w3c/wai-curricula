...
* Determine if HTML5 sectioning elements and WAI-ARIA landmarks in use meet the following success criteria from Web Content Accessibility Guidelines (WCAG):
