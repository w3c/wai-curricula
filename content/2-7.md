---
title: "[Draft] Module 7: Dynamic Content"
permalink: /curricula/developer-modules/dynamic-content/
ref: /curricula/developer-modules/dynamic-content/
lang: en
github:
...
* explain the use of proper coding to communicate changes in dynamic content to assistive technologies
* explain how people with disabilities process and interact with content updates, such as state changes or live regions

## Learning Outcomes for Module

Students should be able to:

* identify dynamic content regions in web pages or applications
* mark up dynamically generated updates in pages or applications using live regions so that they are perceived by assistive technologies
* mark up visible and hidden content so that its state is perceived by people with disabilities
* code keyboard interactions in web applications that allow to navigate between their components
* code the DOM order so that it allows for a consistent navigation in single page or rich internet applications
* mark up and update structural components such as title and main heading as new content becomes available
