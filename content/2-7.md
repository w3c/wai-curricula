...
Demonstrate the use of markup and coding techniques to communicate the overall structure and relationships in a rich applications. Discuss elements that are common to all application views, such as title or main heading. 

#### Learning Outcomes for Topic

Students should be able to:

* code application structural elements such as titles, headings, and regions
* code relationships between different application components, such as navigational mechanisms, text areas, or other functional components
* mark up different states of application components, such as displayed or hidden
...
Demonstrate the use of coding techniques to implement navigational mechanisms in rich applications, such as application menus, toolbars, or shortcuts.

#### Learning Outcomes for Topic

Students should be able to:

* code menu containers using `role="menubar"
* code menu items that do not contain submenus using `role="menuitem`
* code menu items that contain submenus using `role="menu"
* code states for menu items using the appropriate WAI-ARIA states and properties
* mark up the currently selected item in a menu using a distinguishable style and the attribute `aria-current`
...
#### Topic: Notifications and Updates
