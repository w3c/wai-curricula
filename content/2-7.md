...
* summarize related requirements for designers to establish the priority of notifications based on user interaction 
* summarize related requirements for designers to establish the priority of automatically generated updates for application components
* summarize related requirements for designers to allow to switch updates or notifications on or off based on user preference
...
Demonstrate the use of markup and coding techniques to communicate the overall structure and relationships in rich applications. Discuss elements that are common to all application views, such as title or main heading. 

#### Learning Outcomes for Topic

Students should be able to:

* code and update application structural elements such as titles, headings, and regions as view changes occur
...
* mark up the `displayed` state of application components removing `aria-hidden` from its containers when they become visible
...
Demonstrate the use of coding techniques to implement navigational mechanisms in rich applications, such as application menus, toolbars, or shortcut keys.
