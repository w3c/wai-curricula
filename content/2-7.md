...
kpermalink: /curricula/for-developers/dynamic-content/
ref: /curricula/developer-moduless/dynamic-content/
lang: en
github:
...
navigation:
  previous: /curricula/for-developers/custom-widgets/
---
...
* explain use of proper coding to communicate dynamic content changes to assistive technologies
* explain how people with disabilities interact and process dynamic content changes
...
* mark up state changes in pages or applications using live regions
* coe DOM order for web applications such as single page applications
* code focus management for web applications
* markup and update structural components such as title and main heading as new content becomes visually available
