...
* [[How People with Disabilities Use the Web]]({{ '/people-use-web/' | relative_url }}) &mdash; Describes some of the barriers that people encounter using the Web; and introduces types of assistive technologies and adaptive strategies that some people use.
