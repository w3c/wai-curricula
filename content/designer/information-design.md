...
* design user interfaces that support splitting large amounts of text into several smaller and more manageable pieces, for example by using headings and rank levels, pages, and chapter markers
