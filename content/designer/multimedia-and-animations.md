...
* Emphasize that designers must avoid flashing content, as it can create seizures and other physical reactions. Explain the requirements for this content to flash only up to three times in one second or to be below the general flash and red flash thresholds. Invite students to research about the general flash and red flash ratios. For references on the accessibility requirements of flashing content, see [Understanding Success Criterion 2.3.1: Three Flashes or Below Threshold](https://www.w3.org/WAI/WCAG21/Understanding/three-flashes-or-below-threshold).
