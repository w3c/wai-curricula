...
Explain how HTML5 input types and validation techniques allow to notify users about successes, errors, or any other warning messages resulting from their input. For example, `date`, `time`, or `url`.  
