...
* demonstrate use of proper code to:
  * label form elements
...
* label form elements so that they can be understood by users and assistive technologies
* group form elements that share a common purpose
* mark up instructions that help understand form elements' purpose
* notify users of errors or successes during and after form completion
* explain how labels and instructions allow people with disabilities to navigate, fill in, and perceive information from form elements
...
Explain use of HTML elements and WAI-ARIA attributes to label form elements. For example, the `label` element and the `for attribute.
...
* explain how labels allow people with disabilities to identify and fill in form elements
...
* Demonstrate use of voice commands, keystrokes, or gestures provided by speech and mainstream technologies to navigate web pages through form elements. Explore advanced functionality that some tools provide, such as  presenting all form elements in a list where users can select the form element they are interested in. Examples of how people with disabilities interact with the Web,  see [Stories of Web Users](https://www.w3.org/WAI/people-use-web/user-stories/).
...
* Show examples of required form elements using the HTML attribute `required` or some added text in the label. Examples on how to validate required input are provided in the WAI website tutorials [Validating required input](https://www.w3.org/WAI/tutorials/forms-and-input-elements/validation/#validating-required-input).
* Demonstrate use of some common HTML5 elements, such as `date`, `time`, `url`, or `email`. Explain that they allow users to enter data more reliably and help validation. Examples on how to validate common input are provided in the WAI website tutorials [Validating common input](https://www.w3.org/WAI/tutorials/forms-and-input-elements/validation/#validating-common-input).
...
* code information about the amount of errors in the main heading of the page, the page title, or via modal dialogs
* associate error messages with their corresponding form elements using headings, lists, or anchors
* code inline feedback using messages belonging to specific form elements via labels, icons, or the `aria-describedby` attribute
