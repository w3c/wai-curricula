...
* [Module 1: Structure and Semantics](/curricula/developing-accessible-content/structure-and-semantics/) from [Developing Accessible Content](/curricula/developing-accessible-content)
* Basic knowledge ofs [HTML forms](https://html.spec.whatwg.org/multipage/forms.html#forms)
...
* code labels and input fields associations using the HTML attribute `for`, the HTML element `title`, or the WAI-ARIA attributes `aria-label` or `aria-labelledby`, and identify use cases for each of them
