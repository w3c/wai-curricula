...
* code common regular expressions using the `pattern` attribute

#### Teaching Ideas

Optional ideas to teach the learning outcomes:

* Show examples of required form elements using the `required` element or some added text in the label. For reference on how to validate required input, see the WAI website tutorials [Validating required input](https://www.w3.org/WAI/tutorials/forms-and-input-elements/validation/#validating-required-input).
