...
* **Communicate accessibility as an evolving process** &mdash; Communicate that accessibility needs to be implemented and sustained throughout the design and development processes. Everybody in the team has responsibilities when it comes to accessibility, and these should be clearly outlined and communicated in the planning phase. For reference of how to plan and manage accessibility, see [Planning and Managing Web Accessibility](/planning-and-managing/).
