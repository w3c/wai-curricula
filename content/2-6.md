...
* Invite students to use the keyboard to navigate accessible widgets such as treeviews, tabs, and carousels. Explain that tabbing moves between components and using the arrow keys moves inside components. Emphasize that there should be only one tabstop per component in a page, and that additional keyboard interactions are made availble once each of the component gains focus. An explanation of these keyboard interactions is provided in the WAI-ARIA authoring practice, [Fundamental keyboard navigation conventions](https://www.w3.org/TR/wai-aria-practices/#kbd_generalnav).
