...
* explain how to code keyboard navigation, focus manageent, states, and alerts in custom widgets
...
* code accessibility role of custom widgets using WAI-ARIA roles
...
* Show examples of DOM methods to modify properties of DOM objects. Explain that the accessibility tree is a representation of all the accessibility properties based on a particular DOM.
...
* Show examples of WAI-ARIA roles applied to different types of custom widgets. For example, `button`, `heading`, `menubar`, `menu`, `menuitem, or `grid`. Explain how these roles help assistive technologies interpret the purpose of the widget. For reference on the different categories of WAI-ARIA roles, see the WAI-ARIA authoring practices, [Design Patterns](https://www.w3.org/TR/wai-aria-practices/#x3-design-patterns-and-widgets).
