...
* Practical &mdash; Students are asked to code an accessible custom listbox using the focused and selected states where appropriate. Assess students' understanding of how to code the `selected` state.
