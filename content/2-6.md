...
Refer back to previous modules to demonstrate how standard HTML elements that convey semantic information implicitly convey roles by default. Show examples of carousels, treeviews, or tabs, with and without accessibility properties. Demonstrate use of different roles and how to code them using WAI-ARIA roles.
...
* Practical &mdash; Students are presented with a set of HTML elements and are asked about the semantics they convey. Assess students' knowledge of HTML elements and the associated semantic properties.
...
* Practical &mdash; Students are presented with custom widgets that does not convey roles by default and are asked to assign their roles. Assess how students code roles for custom widgets.
...
* identify mechanisms of browsers to calculate accessible names and descriptions based on markup
