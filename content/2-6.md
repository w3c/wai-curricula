...
Refer back to previous modules to demonstrate how standard HTML widgets implicitly convey accessibility properties by default. Show examples of non-standard widgets such as carousels, treeviews, and tabs, and explain why it is necessary to explicitly manipulate such properties using appropriate DOM methods.

Mention that standard widgets are always preferred from an accessibility perspective, and that use of non-standard widgets is only recommended when there is no standard alternative.
