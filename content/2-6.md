...
* Explain different keyboard modes that some assistive technologies include, such as virtual or application. Explain that in the virtual mode most of the keyboard presses are captured by the assestive technology, whereas in the application mode all ekystrokes pass directly to the application, and it is the responsibility of the application maker to provide all keyboard interaction.
