...
* explain how to modify accessibility properties of a given object
...
Present and discuss some accessibility properties. Explain how they can be altered, modified, or removed using HTML elements, CSS, WAI-ARIA and Javascript.
...
* code additional semantics for a DOM nodes using WAI-ARIA roles and properties when HTML elements cannot convey enough semantic information
...
Explain commonly used keyboard conventions, such as tabbing, using the arrow keys to move through elements in a list, or using shortcuts to access elements quickly.
...
* add focus to an element when it needs to be focusable using the HTML attribute `tabindex="0"`
* remove focus from an element that does not need to be focusable using the HTML attribute `tabindex="-1"`
