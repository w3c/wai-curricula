...
* identify and write code for appropriate values for states and properties, and ensure these values are updated to reflect the current state of widgets as users interact with them or as they are otherwise updated
...
* write code that allows custom widgets to be operateed using the keyboard only and other input devices, such as voice interaction
