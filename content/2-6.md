...
Present and discuss some accessibility properties. Explain how they can be altered, modifided, or removed using HTML elements, CSS, WAI-ARIA and Javascript.
...
* explain how the accessibility tree can be altered using HTML, CSS, WAI-ARAI, and JavaScript
* code aditional semantics in the DOM nodes using WAI-ARIA roles and properties when HTML elements cannot convey enough semantic information
