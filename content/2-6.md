...
Demonstrate use of  different roles and how to code them using WAI-ARIA. Show examples of required states and properties for each of the roles.
...
* Show examples of custom checkboxes, menubars, radio groups, or toolbars. Mention use of the WAI-ARIA attribute `aria-checked` to communicate the state of the checkbox. Explain that only one of these items can have `aria-checked` set to true at a given time. Examples on how to use the WAI-ARIA attribute `aria-checked` are provided in the index of ARIA design patterns, [examples of aria-checked](https://www.w3.org/TR/wai-aria-practices/examples/#examples_by_props_label#examples_by_props_label).
* Show examples of custom toggle buttons and toolbars where the `pressed` state is visually conveyed. Indicate that it is necessary to communicate that information using the WAI-ARIA attribute `aria-pressed`. Examples on how to code the `pressed` state are provided in the index of ARIA design patterns, [examples of aria-pressed](https://www.w3.org/TR/wai-aria-practices/examples/#examples_by_props_label).
* Show examples of comboboxes, listboxes, and tabs where the `selected` state is used. Indicate that it is necessary to communicate that information using the WAI-ARIA attribute `aria-selected`. Examples on how to code the `selected` state are provided in the index of ARIA design patterns, [examples of aria-selected](https://www.w3.org/TR/wai-aria-practices/examples/#examples_by_props_label).
