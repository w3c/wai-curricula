...
Refer back to previous modules to demonstrate how standard HTML elements that convey semantic information implicitly convey roles by default. Demonstrate use of different roles and how to code them using WAI-ARIA roles.
