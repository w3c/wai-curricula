...
* Markup header cells and data cells using the `th` and `td` elements respectively.
* Associate data cells with header cells in complex tables via the `headers` attribute.
