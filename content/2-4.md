...
* Basic knowledge of the HTML element [`table` {% include_cached icon.html name="external-link" %}](https://html.spec.whatwg.org/multipage/tables.html#the-table-element)
...
* Applied expertise in teaching:
  ...
  * HTML elements [`table` {% include_cached icon.html name="external-link" %}](https://html.spec.whatwg.org/#the-table-element), [`tr` {% include_cached icon.html name="external-link" %}](https://html.spec.whatwg.org/multipage/tables.html#the-tr-element), [`th` {% include_cached icon.html name="external-link" %}](https://html.spec.whatwg.org/multipage/tables.html#the-th-element), and [`td` {% include_cached icon.html name="external-link" %}](https://html.spec.whatwg.org/multipage/tables.html#the-td-element)
  * HTML elements [`colgroup` {% include_cached icon.html name="external-link" %}](https://html.spec.whatwg.org/multipage/tables.html#the-colgroup-element)
  * HTML element [`col` {% include_cached icon.html name="external-link" %}](https://html.spec.whatwg.org/multipage/tables.html#the-col-element)
  * HTML element [`tbody` {% include_cached icon.html name="external-link" %}](https://html.spec.whatwg.org/#the-tbody-element)
  * HTML attributes [`scope` {% include_cached icon.html name="external-link" %}](https://html.spec.whatwg.org/multipage/tables.html#attr-th-scope) and [`headers` {% include_cached icon.html name="external-link" %}](https://html.spec.whatwg.org/#attr-tdth-headers)
  * HTML element [`Caption` {% include_cached icon.html name="external-link" %}](https://html.spec.whatwg.org/multipage/tables.html#the-caption-element) and attribute [`Summary` {% include_cached icon.html name="external-link" %}](https://html.spec.whatwg.org/multipage/obsolete.html#attr-table-summary)
