...
* Practice &mdash; Students are presented with an irregular table and are asked to code its headers using the attribute `headers`. Assess how students use the attribute `headers` in data cells with unique identifiers.
