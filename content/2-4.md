...
navigation:
  ...
  next: /curricula/developer-modules/forms-and-input-elements/
---
...
* explain the use of accessible coding to associate header and data cells and to describe the topic and purpose of a table
