...
* Understand how screen reader users review one cell at a time using specific key combinations.
* Understand how header cells are spoken before or after data cells by screen readers as users move between cells.
* Understand how some people may use custom stylesheets or different screen sizes to display table data in an alternative format.
