...
* mark up menus as lists, sub-lists, and list items, for example using the HTML elements `ul`, `ol`, and `li`
...
* write code to operate functionality of fly-out menus using different input devices including the keyboard only and voice interaction
...
* mark up application menus using the WAI-ARIA property `role="menubar"`
* mark up individual menu items using the WAI-ARIA property `role="menuitem"`
* mark up application menu items containing submenus using the WAI-ARIA property `role="menu"`
* mark up application menus using the HTML element `tabindex` so that they can receive keyboard focus
* write code to operate functionality of application menus using keyboard and other input devices
