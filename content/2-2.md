...
Explain use of additional WAI-ARIA roles and properties to mark up  application menus. Discuss additional functionality to make application menus operable by people using only the keyboard.
