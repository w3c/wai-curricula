...
* explain accessible coding to provide accessible structures, labeling, and functionality of menus
...
Refer back to [Module 1: Structure and Semantics](/curricula/developer-modules/structure-and-semantics/) and explain the use of HTML elements to identify menus and convey their structure.
