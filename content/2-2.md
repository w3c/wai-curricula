...
* demonstrate use of appropriate code to provide structure, labels, and functionality of menus
...
Show examples of specific scenarios where application menus can be used, such as recreating a desktop environment in a Web application.  
