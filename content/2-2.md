...
* explain how structure, labels, markup, and styling allow people with disabilities to interact with and navigate using menus

## Learning Outcomes for Module

Students should be able to:

* identify and mark up the presence of menus using headings or the HTML element `nav`
...
Explain use of HTML elements to identify menus and convey their structure.
