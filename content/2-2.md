...
* Show examples of the HTML5 element `nav` to mark up a region as navigational. An example of how to use this element is provided in the WAI tutorials, [Identify menus](https://www.w3.org/WAI/tutorials/menus/structure/#identify-menus).
* Refer back to the HTML elements `ul`, `ol`, and `li` taught in the previous module. Explain that they serve to structure and organize lists and list items. Examples on how to use these elements within a menu structure are provided in the WAI tutorials, [Menu representation](https://www.w3.org/WAI/tutorials/menus/structure/#menu-representation).
...
* list complimentary requirements for authors to write menu item texts 
* list complimentary requirements for  designers to design visual styles for menus and menu items

### Teaching Ideas

Optional ideas to teach the learning outcomes.

* Show examples of different types of menus, such as navigational, application, or breadcrumb trails. Explain that they need to be coded so that they are placed in the expected position within the page. Mention that menu location is a shared responsibility among different team members: content authors, designers, and developers. Examples of the expected positions of menus within the page are provided in the WAI tutorials, [Location](https://www.w3.org/WAI/tutorials/menus/styling/#location).
...
* Show examples of menus that contain submenu items. Explain that the layer with the submenu items needs to be coded as a nested list, and that each of the submenu items need to be coded as a list item. An example of the structure of menu and submenu items is provided in the WAI tutorials, [Indicate submenus](https://www.w3.org/WAI/tutorials/menus/flyout/#indicate-submenus).
* Explain use of the WAI-ARIA attribute `aria-haspopup` to mark up the presence of submenu items. Indicate that this attribute should be present in the original HTML markup. An example of how to use the WAI-ARIA attribute `aria-haspopup` is provided in the WAI tutorials, [Indicate submenus](https://www.w3.org/WAI/tutorials/menus/flyout/#indicate-submenus).
* Show examples of different ways to interact with fly-out menus, such as using the mouse or the keyboard. Examples on how to make functionality of fly-out menus available to all users are provided in the WAI tutorials, [Fly-Out functionality](https://www.w3.org/WAI/tutorials/menus/flyout/#fly-out-functionality). 
* Explain that the WAI-ARIA attribute `aria-expanded` conveys if the submenu items are visible or hidden. Explain that the attribute needs to be present in the original HTML markup. Examples of how to use the `aria-expanded` attribute are provided in the WAI tutorials, [Indicate submenus](https://www.w3.org/WAI/tutorials/menus/flyout/#indicate-submenus).
...
* identify situations where an appication menu is appopriate
...
* Show examples of different application menus. Explain that additional markups necessary for assistive technologies to render these menus adequately. Examples of how to code application menus are provided in the WAI tutorials, [Additional markup](https://www.w3.org/WAI/tutorials/menus/application-menus/#additional-markup).
* Show examples of how an application menu is operated using the keyboard. Explain that additional functionality needs to be added via scripts so that keyboard patterns resemble those of a desktop menu. Examples of how to code application menus so that they can be operable by keyboard are provided in the WAI tutorials, [Functionality](https://www.w3.org/WAI/tutorials/menus/application-menus/#functionality) and [Keyboard behavior](https://www.w3.org/WAI/tutorials/menus/application-menus/#keyboard-behavior).
