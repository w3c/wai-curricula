...
* Identify other navigational mechanisms such as breadcrumb trails, site maps, and toolbars.
...
* Define breadcrumb trails as a way for users to keep track of the hierarchical structure of a particular web page within a set of web pages. Present examples of its structure and common patterns to include them.
* Define site maps as a list of all the pages in a site. Explain that they can be ordered alphabetically, by topic, or by category within the website's structure.
