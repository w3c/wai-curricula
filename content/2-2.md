...
Introduce the concept of navigation menus. Explain its characteristics and some strategies to make them accessible.
...
* Introduce the concept of navigation menu. Emphasize that there might be one or several of them in a website, and that all of them should be marked-up adequately.
...
* Introduce the roles of nav, list, and listitem. Give examples of its usage and explain how some assistive technologies communicate them.
