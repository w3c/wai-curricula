...
* Analyze if a given navigation pattern can be used and understood by keyboard and assistive technology users.
* Determine if navigation elements meet the success criteria 2.4.3 (Focus order), 2.4.5 (Multiple ways), 2.4.7 (Focus visible), 2.4.8 (Location), and 4.1.2 (Name, Rol, Value) of WCAG.
