...
* Explain strategies that people with disabilities use to navigate across web pages and to locate contents.
...
* Applied expertise in teaching:
  ...
  * [WCAG 2 Success Criterion 2.4.8 Location](https://www.w3.org/WAI/WCAG21/quickref/?showtechniques=241#location).
...
### Topic: Locating Pages and Content
...
* Describe strategies to navigate across web pages and to locate content using:
  * Search functions.
...
* Invite students to explore search functions. Explain that they allow users to locate content by typing words that are part of the website. Explain that they can be included using either a form field with a button to trigger the search, or a link that takes to the search form. For examples of search functions, see technique [G161: Providing a search function to help users locate content](https://www.w3.org/WAI/WCAG21/Techniques/general/G161.html).
...
* Short answer questions &mdash; Students are asked how many different navigational mechanisms they are aware of and are asked to explain its main features. Assess students' knowledge of how people navigate across web pages and locate specific content.
...
* Portfolio &mdash; Students add a set of web pages to the website they are building. Then they provide navigational mechanisms so that users can go to the different web pages and can locate content. Assess how students implement, identify, organize, and label navigational mechanisms.
