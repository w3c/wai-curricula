...
permalink: /curricula/curriculum-for-developers/navigational-menus/
ref: /curricula/curriculum-for-developers/navigational-menus/
lang: en
github:
...
resource:
  ref:
    ...
    - /curricula/
navigation:
  previous: /curricula/curriculum-for-developers/structure-and-semantics/
  next: /curricula/curriculum-for-developers/images-and-graphics/
---
...
* explain the use of proper coding to provide accessible structures, labeling, and functionality of menus
...
* [Module 1: Structure and Semantics](/curricula/curriculum-for-developers/structure-and-semantics/) from [Curriculum for Developers](/curricula/curriculum-for-developers/)
...
* In-depth knowledge of:
  * [Prerequisites for Students](/curricula/curriculum-for-developers/#prerequisites-for-students)
  * [Structure and Semantics](/curricula/curriculum-for-developers/structure-and-semantics/)
...
Refer back to [Module 1: Structure and Semantics](/curricula/curriculum-for-developers/structure-and-semantics/) and explain the use of HTML elements to identify menus and convey their structure.
