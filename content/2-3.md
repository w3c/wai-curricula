...
* write text alternatives for button images, link images, and image input types that describe the action they are carrying out
...
* Show examples of  button and image input types, such as those for printing or saving. Explain that they need to refer to the action that the image conveys. Examples of several text alternatives for functional images are provided in the WAI website tutorials, [Functional Images](https://www.w3.org/WAI/tutorials/images/functional/).
* Show examples of adjacent texts that may influence the text alternative for functional images. Explain that when the adjacent text conveys the action performed by the image, a null alternative text should be provided.
...
* Discuss ways to provide additional descriptions for complex images and groups of images such as charts and diagrams. For example the HTML elements `fig` and `figcaption`, the WAI-ARIA attribute `aria-describedby` or the HTML attribute `longdesc`. Mention that `longdesc` may not be well supported by some browsers or assistive technologies. Examples on how to describe complex images are provided in the WAI website tutorials, [Complex images](https://www.w3.org/WAI/tutorials/images/complex/).
* Explain that the MathML language can be used to code mathematical expressions on the Web. Emphasize that screen reader support for MathML on the Web is growing, but other assistive technology users may need additional browser extensions to access contents in MathML. Examples on how to use the MathML language to code mathematical expressions are provided in the WAI website tutorials, [mathematical expressions](https://www.w3.org/WAI/tutorials/images-and-graphics/textual/#mathematical-expressions).
