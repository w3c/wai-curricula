...
* Demonstrate knowledge about how to code alternative texts for images.
...
* Use the `alt` attribute to provide accessible descriptions for images included using the `img` tag or the `image` input type of HTML.
