...
* Specify use of HTML elements and CSS techniques to make images and graphics accessible.
...
* Mark up and provide alternative texts for image.
...
* Demonstrated completion of courses based on:
...
* Basic knowledge of:
  * HTML [`img` element](https://html.spec.whatwg.org/multipage/embedded-content.html#the-img-element) and [`alt` attribute](https://html.spec.whatwg.org/multipage/embedded-content.html#attr-img-alt).

Instructors:

* Applied expertise in teaching:
  * [WCAG 2 Success Criterion 1.1.1 Non-text Content](https://www.w3.org/WAI/WCAG21/quickref/?showtechniques=241#non-text-content).
  * [WCAG 2 Success Criterion 1.4.5 Images of Text](https://www.w3.org/WAI/WCAG21/quickref/?showtechniques=241#images-of-text).
  * [WCAG 2 Success Criterion 1.4.9 Images of Text (No Exception)](https://www.w3.org/WAI/WCAG21/quickref/?showtechniques=241#images-of-text-no-exception).
  * HTML [`img` element](https://html.spec.whatwg.org/multipage/embedded-content.html#the-img-element) and [`alt` attribute](https://html.spec.whatwg.org/multipage/embedded-content.html#attr-img-alt).
...
* Describe strategies to access information contained in images and graphics using:
...
* Invite students to explore speech input software to jump through the different images of a page by voicing specific words or phrases. Compare the experience with that of a web page where there is no alternative text. For reference on how screen reader users access information contained in images and graphics, see [Stories of Web Users](https://www.w3.org/WAI/people-use-web/user-stories/).
...
* Show examples of images of text. Explain that these images are indeed text coded as an image in machine language. Emphasize that text within an image object cannot be interpreted by assistive technologies, cannot be resized, and and that its background and foreground colors cannot be modified. For reference on images of text, see the WAI website tutorials, [Images of Text](https://www.w3.org/WAI/tutorials/images/textual/).
...
* Practice &mdash; Students are presented with the same image in different pages and are asked to provide different text alternatives. Assess how students take into account the context of a web page to provide alternative texts.
...
Describe several mechanisms to provide text alternatives for image. For example, `alt` text, `aria-label`, or `aria-labelledby`. Emphasize that some additional descriptions may be provided by content authors.
...
* Explain that sometimes alternative texts are not enough to convey the information. Discuss ways to provide additional descriptions for complex images and groups of images, for example `fig` and `figcaption`, `aria-describedby` or `longdesc`. For reference on how to describe complex images see the WAI website tutorials, [Complex images](https://www.w3.org/WAI/tutorials/images/complex/).
