...
* Use CSS properties, fonts, and markup languages to style text decorations instead of images of text.
* Use markup languages instead of using images of text.
...
* Show examples of complex images, such as graphs, charts, or diagrams. Explain that charts may be described using tables, and other complex images may need its own dedicated page with its description. Remember that describing images is a shared responsibility among different team members: content authors, designers, and developers. For reference on complex images, see the WAI website tutorials [Complex Images](https://www.w3.org/WAI/tutorials/images/complex/).
...
* Code `picture`, `img` elements, and `image` input types with the alt attribute.
...
* Style decorated text with CSS Transforms and CSS Fonts technologies instead of using images of text.
