...
* Explain how screen reader users can get information about a given image via the text alternative, a description of the image contents in plain text. State that it is not necessary to include the word "image" in the alternative text, since that piece of information would be separately announced if the image role is used appropriately. Indicate that most screen readers have specific keystrokes to navigate between images, and have functions to show all images of a web page in a list.
