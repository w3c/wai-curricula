...
permalink: /curricula/developer-modules/images-and-graphics/
ref: /curricula/developer-modules/images-and-graphics/
lang: en
github:
...
navigation:
  previous: /curricula/developer-modules/navigational-menus/
  next: /curricula/developer-modules/tabular-information/
---
...
* code informative images using the HTML attributes `alt` and `title`, and WAI-ARIA attributes `aria-label` and `aria-labelledby`, and understand how these attributes are processed by assistive technologies to provide text alternatives
...
* code functional images using the HTML attributes `alt` and `title`, and WAI-ARIA attributes `aria-label` and `aria-labelledby`, and understand how these attributes are processed by assistive technologies to provide text alternatives
