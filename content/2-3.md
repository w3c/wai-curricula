...
* Show examples of informative and decorative images and define their scope and purpose. Show the same image in different web pages and explain that an image can belong to different types depending on the context. For references on informative and decorative images, see the WAI website tutorials, [Decorative Images](https://www.w3.org/WAI/tutorials/images/decorative/) and [Informative Images](https://www.w3.org/WAI/tutorials/images/informative/).
* Demonstrate use of commands, keystrokes, or gestures of text-to-speech technologies to move to next or previous image. Explore advanced functionality which presents all images in a list where users can select the image they are interested in. For reference on how people with disabilities interact and navigate web pages, see [Stories of Web Users](https://www.w3.org/WAI/people-use-web/user-stories/).
...
Explain the purpose and scope of functional images.
...
* write text alternatives for functional images
...
* Short Answer Ques>ions &mdash; Students are asked what a functional image is. A/se/s students undertanding of the purpose and scope of functional images.
* Practice &mdash; Students are presented with functional images with and without surrounding text and are asked to provide alternative texts accordingly. Assess howstudents provide alternative texts for functional images based on context.
