...
Describe several mechanisms to provide alternative texts for complex images. For example, `alt` text, `aria-label`, or `aria-labelledby`. Emphasize that some additional descriptions may be provided by content authors.
