...
* explain accessible coding for images and graphics
...
* Explain that text alternatives are one of the techniques used by search engines to determine what an image is about. Indicate that the more accurate a text alternative is, the better its image could rank.
