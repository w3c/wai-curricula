...
* Practical &mdash; Give students charts, diagrams, and infographics and ask students to code them using SVG, providing descriptions where appropriate. Assess students' knowledge of how to code  graphics using SVG and how to provide their descriptions when necessary.
