...
* Use CSS properties, fonts, and markup languages to code text animations.
...
Explain strategies that people use to interact with images and graphics. Mention scenarios where alternative texts can help users access information which would not be available otherwise. Relate accessible images to WCAG success criterion [1.1.1 Non-text Content](https://www.w3.org/WAI/WCAG21/quickref/#non-text-content), [1.4.5 Images of Text](https://www.w3.org/WAI/WCAG21/quickref/#images-of-text), and [1.4.9 Images of Text (No Exception)](https://www.w3.org/WAI/WCAG21/quickref/#images-of-text-no-exception)..
...
* Invite students to explore screen readers functionality to get information about a given image via the alternative text, a description of the image contents in plain text. Indicate that most screen readers have specific keystrokes to navigate between images as well as functions to list all alternative texts of a web page.
...
* Practical &mdash; Students are shown image buttons or links without alternative texts and are asked to provide them. Assess how students provide adequate alternative texts for some specific types of images.
...
* Practical &mdash; Students are presented with the same image in different pages and are asked to provide different alternative texts. Assess how students take into account the context of a web page to provide alternative texts.
...
Describe several mechanisms to provide alternative texts for image. For example, `alt` text, `aria-label`, or `aria-labelledby`. Emphasize that some additional descriptions may be provided by content authors.
