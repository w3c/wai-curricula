...
* Short Answer Questions &mdash; Students are asked what a functional image is. Assess students undertanding of the purpose and scope of functional images.
...
* Explain that charts and diagrams need to have additinal descriptions. Discuss ways to provide additional descriptions for complex images and groups of images, for example the HTML elements `fig` and `figcaption`, the WAI-ARIA attribute `aria-describedby` or the HTML attribute `longdesc`, depending on context. Examples on how to describe complex images are provided in the WAI website tutorials, [Complex images](https://www.w3.org/WAI/tutorials/images/complex/).
