...
Provide examples on the wide range of diverse abilities of people and introduce some of the barriers that people encounter when interacting with the Web. Explain the meaning of assistive technologies and adaptive strategies and provide an overview of some of them, relating them to design features and barriers. Use the [[How People with Disabilities use the Web]](#how-people-use-web) resource for reference.  
...
The objective of this unit is to introduce students to some design barriers, features, adaptive strategies, and assistive tools, and to provide an overview on the inter-relations between the different components that build accessibility.
...
### Topic: Diverse Abilities, Barriers, Tools, and Strategies
...
* Awareness of the diversity of abilities of people
* Knowledge of some implementation barriers that people encounter when using the web
* Knowledge of a variety of adaptive strategies and assistive tools
...
* Explain the diversity and abilities of people by focusing on the capabilities of the person. Emphasis what they can do and how accessible design is crucial for them to perform the tasks of their daily life.
...
Ask learners to use assistive technologies to perform a task of their choice, e.g., reading the news, making a purchase, interacting in social networks, etc. Ask them if they have also used some kind of adaptive strategy in addition to the assistive tool.
...
Explain that Web Accessibility is made up of several inter-dependent components, each having their own responsibilities for the overall accessible user experience. Emphasize the importance of considering people with disabilities all throughout the stages of the project. Introduce the web accessibility standards from W3C and explain how they help include accessibility features in all components and projects.

{% include excol.html type="middle" %} 

#### Learning Outcomes

* Knowledge of the inter-relation between web accessibility, web technologies, and web components
* Awareness of the existence of accessibility standards and guidelines referring to specific components of web accessibility
* Awareness of the importance of including people with disabilities  throughout all the stages of the project

#### Suggested Teaching Activities

* Explain the inter-relations between accessibility features in web technologies such as HTML, in web content, web authoring tools, web browsers, and assistive tools. Explain that all of these components work together to promote accessibility, each within their own field of action. Use the alternative for images as an example, where content creators, user agents, HTML specification, and assistive technologies are all involved to provide an accessible user experience to the user.
...
Ask students to pick some accessibility barriers and features and encourage them to elaborate on how their implementation depends on each of the components they have learned about.
