...
**Tip**: While it is important to introduce different types of disabilities, avoid focusing on there medical aspects. Communicate that barriers are caused by design decisions rather than by the disability.
...
* Provide students with a set of web sites of your choice and ask them to use them with three different browsers. Have them explain any differences between viewing the content with the different browsers and make a decision as to which browser works best and why.
