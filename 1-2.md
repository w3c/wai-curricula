...
* Ask students to go to three different types of websites (e.g., shopping site, banking site, entertainment site) and try to identify three access barriers from each of the three sites. Ask students to creatively explain how better design may remove those barriers found.
...
* Ask students to choose one type of accessibility feature in content technology and identify 2 or 3 websites where it is being used effectively. For example, where are ordered and unordered lists used effectively, where is heading structure in place, etc.
