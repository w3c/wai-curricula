...
* Explain the inter-relations between accessibility features in web technologies such as HTML, in web content, web authoring tools, web browsers, and assistive tools. Explain that all of these components work together to promote accessibility, each having their own field of action.Use for instance, the alternative for images as an example where content creators, user agents, HTML specification, and assistive technologies are all involved to provide an accessible user experience to the user.
