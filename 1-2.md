...
* Identification of diverse types of abilities and related accessibility needs
* List different types of assistive tools and adaptive strategies
* Identify/Describe the impact of design decisions on accessibility for people
* Identify/Describe of the inter-dependencies between components for accessibility
...
* Describe of the responsibility of each of these components in contributing to accessibility
* Describe/explain the existence of W3C standards referring to different components of web accessibility
