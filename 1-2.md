...
* Explain some of the major instances of the impact of design decisions on accessibility for people
...
:   [Advanced] In-depth knowledge of accessibility principles and inclusive design, and expertise in working with people with different types of disabilities.  
    [Medium] good understanding of accessibility and inclusion. Some preparation is advised, especially to present the different types of abilities, tools and barriers.
...
* Ask students to think about relatives, friends, or colleagues with disabilities that they may have. Ask students to reflect on which types of assistive tools and adaptive strategies their acquaintances use to interact with digital technology. Complete the information of students where necessary.
* Guide students to focus on the abilities of people with disabilities and on how technology is part of their every day life. Coach students towards thinking about people and promote an inclusive approach.
...
* Encourage learners to try some adaptive strategies following expert advise by exploring different settings in web browsers and operating systems.
* Discuss with students various accessibility design features of common sites or devices, as well as access barriers that people experience with digital content. Help them understand the every day impact of design decisions on people with disabilities.
**Tip**: While it is important to introduce different types of disabilities, avoid portraying them as being limiting or discomfortable. Communicate that barriers are caused by design decisions rather than by the disability.

#### Homework Ideas

* Ask students to explore the use of assistive technologies to perform a task, such as reading the news, making a purchase, interacting in social networks, etc. Instruct them that their experiences are not that of an assistive technology everyday user.
* Have students go to three different types of websites (e.g., shopping site, banking site, entertainment site) and try to identify three access barriers from each of the three sites. Ask students to creatively explain how better design may remove those barriers found. Share with other students.
* Have students contact a person with a disability and interview them about what access barriers they encounter when trying to access digital content or applications. Students will write up a summary of the interview and share with other students in class.
...
* Have the students choose one type of accessibility feature in content technology and identify 2 or 3 web sites where it is being used effectively. For example, where are ordered and unordered lists used effectively, where is heading structure in place, etc.
...
* Provide students with a set of web sites of your choice and ask them to use them with three different browsers and assistive technologies. Ask them to explain any differences between accessing the content with the different browsers and assistive technologies. Encourage them to make a decision as to which browser works best and why.
...
*(Note: focus questions on functional aspects of accessibility rather than on medical conditions of people. That is, emphasize how accessibility is about enhancing the ability of people to use technology and avoid bringing attention to the defining aspects of a disability)*
