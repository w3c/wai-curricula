...
***Instructors***
:   [Medium] Good understanding of accessibility and inclusion. Some preparation is advised to present the diverse abilities, tools and barriers.
...
* Ask students to think about relatives, friends, or colleagues with disabilities that they may have. Ask students to reflect on which types of assistive tools and/or adaptive strategies their acquaintances use to interact with digital technology. Complete the information of students where necessary.
...
* Ask students to choose one type of accessibility feature in content technology and identify 3 websites where it is being used effectively. For example, where are ordered and unordered lists used effectively, where is heading structure in place, etc.
...
*(Note: focus questions on functional aspects of accessibility rather than on medical conditions of people. That is, emphasize how accessibility is about enhancing the ability of people to use technology*.
