...
Provide examples on the wide range of diverse abilities of people, explain some of the barriers that people encounter when interacting with the Web. Provide an overview on assistive technologies and adaptive strategies relating them to design features. Refer to the [[How People with Disabilities use the Web]](#how-people-use-web) resource .
