...
* Discuss with students the specific role of each of the standards mentioned and compare them with other applicable technical guidelines (if any). Refer to [Why Standards Harmonization is Essential to Web Accessibility](/standards-guidelines/harmonization/)
...
* [How WAI Develops Accessibility Standards through the W3C Process: Milestones and Opportmoduleies to Contribute](/standards-guidelines/w3c-process/) &mdash; Provides a simplified overview of the W3C standards development process, and opportmoduleies for everyone to contribute to development of standards and resources.
