...
* Provide hands-on experience checking how web pages have implemented the standards or not
...
* Good understanding of the W3C accessibility standards, and knowledge of how to check web pages for some potential accessibility barriers.
...
* Students write a summary describing the four principles of web accessibility and give examples. For instance, captions and other alternatives for multimedia under the principle Perceivable.
* Students come up with other examples of each principle (beyond what is in the W3C "Accessibility Principles" resource).
...
**NOTE:** In this topic students can put their knowledge of accessibility principles and standards into practice. Further accessibility evaluation is beyond the scope of this module. It requires more skills and accessibility knowledge than has been taught so far. 
...
* Students select several accessibility checks and explain which principle(s) and success criteria they belong to.
...
* Presentation &mdash; Students explain the four “POUR principles” of web accessibility and give examples. For instance, students explain the principle Understandable and elaborate on identifying the first language of a page.
* Short Answer questions &mdash; From specific examples of accessibility features, students identify which principle they belong and which users it helps. For instance, Functionality Available from the Keyboard belongs to the principle Operable and helps keyboard users as well as people using voice recognition software.
