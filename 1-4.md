...
* Encourage students to research if there are other technical guidelines for accessibility in their organization. Ask them to specify if they diverge from W3C accessibility standards.
...
* Ask students to select several accessibility checks. Ask them to explain which principle(s) and success criteria they belong to.
