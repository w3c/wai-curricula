...
The objective for this unit is to introduce resources on how to plan, manage and apply accessibility within organizations. The unit provides an overview on organizational planning and managing strategies to ensure accessibility is part of the process, and on different roles and responsibilities which have an influence on accessibility implementations. Key aspects that will help you develop the learning outcomes are:

* Emphasizing how to involve people with disabilities in the whole design and development process has a positive impact on all users
* Underlying the importance of developing policies on how to implement accessibility and respond in an efficient manner to accessibility/related queries from users.
...
* Introduce specific considerations to integrate accessibility throughout the design process. eg.:
