...
**Note:** Select different strategies that best apply to the learners’ situations from the resource [Planning and Managing Web Accessibility](https://www.w3.org/WAI/planning-and-managing/). 
...
* Good understanding of how to introduce and integrate accessibility strategies throughout organizations.
...
* Students select a product of their choice and develop strategies to efficiently plan and manage accessibility. Emphasis on key roles, responsibilities and actions for accessibility to be maintained throughout time.
...
* Multiple choice quiz: List with all accessibility planning and managing strategies. Students  select those they consider important for their particular situation and explain why.
* Report: Students write a report on the current accessibility policies in an organization of their choice. 
* Presentation: Students list different roles and responsibilities involved in web accessibility and describe their associated tasks.
* Presentation: Students describe some strategies to integrate accessibility in any existing project.
