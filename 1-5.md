...
* Describe some accessibility-related tasks and their mapping to specific roles and functions
...
* Introduce the scope of their responsibilities throughout. Emphasize that sometimes a particular accessibility-related task needs involvement from several roles.
...
* Introduce some of the methods to gain an understanding of the current accessibility status in the project, e.g., performing a first review or carrying out a detailed accessibility evaluation, referring to the [Web Accessibility First Aid](#interim-repairs) resource.
