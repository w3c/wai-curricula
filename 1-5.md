...
The objective for this unit is to introduce resources on how to plan, manage and apply accessibility within organizations. It provides an overview on organizational planning and managing considerations to ensure accessibility as part of the process, and on different roles and responsibilities which have an influence on the accessibility implementations. Learning can be reinforced by applying the below strategies:
