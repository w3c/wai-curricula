...
The [Planning and Managing Web Accessibility](https://www.w3.org/WAI/planning-and-managing/) resource contains the necessary information for this topic. Go through the resource and explain the outlined strategies. If you do not have time to teach them all, select those which better adjust to the learner's business context. Emphasize that accessibility is more than a technical implementation. 
...
* Emphasize the importance of involving real users with disabilities early on in the production process. The [Involving Users with Disabilities](https://www.w3.org/WAI/planning/involving-users/) resource contains the necessary information.
* Discuss case studies of organizations that have adopted accessibility. Analyze with students successes and challenges of such cases. The [Business Case for Digital Accessibility](https://www.w3.org/WAI/business-case/) resource contains some case studies.
...
* Ask students to pick up a product or service of their choice and to develop strategies to efficiently plan and manage accessibility. Encourage them to think about key roles and responsibilities as well as key actions that need to be taken to ensure accessibility is maintained throughout time.
