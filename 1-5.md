...
This unit explores different strategies and introduces various resources on how to plan, apply, and manage accessibility. It explains how to develop accessibility policies and statements. It introduces several roles and responsibilities related to accessibility. It provides resources on how to apply accessibility features to an existing project.
...
* Provide case studies of organizations or companies that have integrated accessibility into their projects by referring to the [Business Case for Digital Accessibility](#business-case) resource.
* Engage students in a Start, Stop, Continue exercise to identify processes, tasks, and strategies within their organization for which accessibility implementation may need to be revised. Encourage discussion by bringing in design and development processess, media production, procurement, etc.
...
* Learners should be able to describe some strategies to integrate accessibility in a new or existing project.
