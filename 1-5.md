---
title: "[DRAFT] Module 5: Getting Started with Accessibility"
...
Select strategies that best apply to the students’ context. Refer to [Planning and Managing Web Accessibility](/planning-and-managing/). Emphasize that it is crucial to have management support to succeed in long-term accessibility implementations.
...
* Explain the different types of roles involved in implementing web accessibility. For reference, use [Accessibility Roles and Responsibilities](/EO/wiki/Role_definition_document).
...
* Introduce some accessibility features and specify which role(s) would be responsible for them. Explain that there might be only one role or several roles involved. Go through [Role-Based Decision Tree](/EO/wiki/Role-Based_Decision_Tree).
...
* [(Draft, work in progress)Accessibility Roles and Responsibilities Mapping (ARRM): Role Definition ](/EO/wiki/Role_definition_document) &mdash; Defines a variety of roles relevant for accessibility throughout the design and development process. It includes examples tasks in accessibility for each of the roles defined.
* [(Draft, work in progress) Role-Based Decision Tree](/EO/wiki/Role-Based_Decision_Tree) &mdash; A customizable framework to help anyone define an accessibility matrix of their own within their organization.
